...
class UniversalTranslationExtension extends AbstractExtension
{
    ...
    private function generateKeyFromText(string $text): string
    {
        ...
        $keyMap = [
            ...
            'İhale Teklifleri' => 'bids.offers',
            'İhale / Ürün' => 'bids.bid_product',
            'Taraf' => 'general.party',
            'Son Güncelleme' => 'general.last_update',
            'Alım Talepleri' => 'purchase_request.requests',
            'Ürün Adı' => 'products.product_name',
            'Tarih' => 'general.date',
            'Henüz bir mesajınız yok.' => 'messages.no_messages_yet',
            'Mesaj Konusu' => 'messages.subject',
            'İhale Detayları' => 'bids.bid_details',
            'İhale Başlangıç' => 'bids.bid_start',
            'İhale Bitiş' => 'bids.bid_end',
            'Teklif Fiyatı' => 'bids.offer_price',
            'Karşı taraf' => 'messages.counterpart',
            'Gönder' => 'general.send',
            'Alım Talebi Mesajları' => 'purchase_request.messages',
            'Alım Talebi Detayları' => 'purchase_request.details',
            'Belirtilmemiş' => 'general.not_specified',
            'Firma sahibi ile mesajlaşma' => 'messages.chat_with_company_owner',
            'Firma Sahibi' => 'companies.company_owner',
        ];
